...
使用方法:
    python src/lattice_studio/infrastructure/native/build_periodic_sdf.py build_ext --inplace
"""
...
print("=" * 70)
print("\n使用方法:")
print("  from lattice_studio.infrastructure.native.cpp_periodic_sdf import sample_periodic_sdf")
